...
if __name__ == "__main__":
    ...
    for rank, maxIter in itertools.product(ranks, maxIters):
        als = ALS(rank = rank, maxTter = maxIter, userCol="userId", itemCol="itemId", ratingCol="rating")
    ...
    print "The best model was trained with rank = %d and alpha = %.1f, " % (bestRank, bestalpha) \
      + "and maxIter = %d, and its RMSE on the test set is %f." % (bestmax:Iter, testRmse)
