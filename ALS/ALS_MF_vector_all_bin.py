...
if __name__ == "__main__":
    ...
    '''
    if you want to read userfactor ot itemfactor
    userfactor = sqlContext.read.parquet('userfactor')
    itemfactor = sqlContext.read.parquet('itemfactor')   
    '''
